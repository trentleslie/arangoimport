...
# 6. Start SPOKE import with optimized parameters and 25 processors
echo "Starting SPOKE import with 25 processors and optimized logging..."
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
echo "Import started at $(date)" > /home/ubuntu/spoke/arangoimport/logs/import_${TIMESTAMP}.log

# Set up a periodic stats check (every 10 minutes)
(
  while true; do
...
# Running with 25 workers for maximum speed with our optimized logging
